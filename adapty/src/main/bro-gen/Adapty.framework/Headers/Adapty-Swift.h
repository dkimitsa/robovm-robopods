...
+ (void)syncTransactionsHistoryWithCompletion:(void (^ _Nullable)(NSDictionary<NSString *, id> * _Nullable, NSArray<PaywallModel *> * _Nullable, NSArray<ProductModel *> * _Nullable, AdaptyError * _Nullable))completion;
