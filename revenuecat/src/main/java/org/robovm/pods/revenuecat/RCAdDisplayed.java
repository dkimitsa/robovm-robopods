...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/RCAdDisplayed/*</name>*/ 
    extends /*<extends>*/NSObject/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class RCAdDisplayedPtr extends Ptr<RCAdDisplayed, RCAdDisplayedPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(RCAdDisplayed.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected RCAdDisplayed() {}
    protected RCAdDisplayed(Handle h, long handle) { super(h, handle); }
    protected RCAdDisplayed(SkipInit skipInit) { super(skipInit); }
    @Method(selector = "initWithNetworkName:mediatorName:adFormat:placement:adUnitId:impressionId:")
    public RCAdDisplayed(String networkName, RCMediatorName mediatorName, RCAdFormat adFormat, String placement, String adUnitId, String impressionId) { super((SkipInit) null); initObject(init(networkName, mediatorName, adFormat, placement, adUnitId, impressionId)); }
    @Method(selector = "initWithNetworkName:mediatorName:adFormat:adUnitId:impressionId:")
    public RCAdDisplayed(String networkName, RCMediatorName mediatorName, RCAdFormat adFormat, String adUnitId, String impressionId) { super((SkipInit) null); initObject(init(networkName, mediatorName, adFormat, adUnitId, impressionId)); }
    /*</constructors>*/
    /*<properties>*/
