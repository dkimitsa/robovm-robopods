...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/ISNativeAdAdapterProtocol/*</name>*/ 
    ...
    void initNativeAds(String userId, ISAdapterConfig adapterConfig, ISNativeAdAdapterDelegate delegate);
    @Method(selector = "initNativeAdForBiddingWithUserId:adapterConfig:delegate:")
    void initNativeAdForBidding(String userId, ISAdapterConfig adapterConfig, ISNativeAdAdapterDelegate delegate);
    ...
    void loadNativeAdForBidding(ISAdapterConfig adapterConfig, NSDictionary<?, ?> adData, String serverData, UIViewController viewController, ISNativeAdAdapterDelegate delegate);
    @Method(selector = "destroyNativeAdWithAdapterConfig:")
    void destroyNativeAd(ISAdapterConfig adapterConfig);
    @Method(selector = "getNativeAdBiddingDataWithAdapterConfig:adData:")
    NSDictionary<?, ?> getNativeAdBiddingData(ISAdapterConfig adapterConfig, NSDictionary<?, ?> adData);
    @Method(selector = "collectNativeAdBiddingDataWithAdapterConfig:adData:delegate:")
    void collectNativeAdBiddingData(ISAdapterConfig adapterConfig, NSDictionary<?, ?> adData, ISBiddingDataDelegate delegate);
    /*</methods>*/
    /*<adapter>*/
    /*</adapter>*/
}
