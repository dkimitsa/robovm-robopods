...
SWIFT_ENUM_FWD_DECL(NSInteger, ChartEasingOption)
...
SWIFT_ENUM_FWD_DECL(NSInteger, AxisDependency)
...
SWIFT_ENUM_FWD_DECL(NSInteger, ChartDataSetRounding)
SWIFT_ENUM_FWD_DECL(NSInteger, ChartLegendForm)
...
SWIFT_ENUM_FWD_DECL(NSInteger, ChartLimitLabelPosition)
...
SWIFT_ENUM_FWD_DECL(NSInteger, ChartLegendHorizontalAlignment)
SWIFT_ENUM_FWD_DECL(NSInteger, ChartLegendVerticalAlignment)
SWIFT_ENUM_FWD_DECL(NSInteger, ChartLegendOrientation)
SWIFT_ENUM_FWD_DECL(NSInteger, ChartLegendDirection)
...
SWIFT_ENUM_FWD_DECL(NSInteger, LineChartMode)
...
SWIFT_ENUM_FWD_DECL(NSInteger, PieChartValuePosition)
...
SWIFT_ENUM_FWD_DECL(NSInteger, ScatterShape)
...
SWIFT_ENUM_FWD_DECL(NSInteger, XAxisLabelPosition)
...
SWIFT_ENUM_FWD_DECL(NSInteger, YAxisLabelPosition)
